...
namespace AM.ApplicationCore.Domain
{
    ...
    {
        public static plane BoingPlane = new plane { PlaneType = PlaneType.Boing, Capacity = 150, ManifactureDate = new DateTime(2015, 02, 03) };
        public static plane Airbusplane = new plane { PlaneType = PlaneType.Airbus, Capacity = 250, ManifactureDate = new DateTime(2020, 11, 11) };
        // Staffs
        // Staffs
